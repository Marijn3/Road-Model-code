...
class WegModel:
    ...
    def __get_remainders(self, geom1, geom2) -> list[LineString]:
        ...
        if isinstance(remainders, LineString) and not remainders.is_empty:
            ...
            logger.warning(f"Could not determine the remainders between\n{geom1}\nand {geom2}")
            return []
